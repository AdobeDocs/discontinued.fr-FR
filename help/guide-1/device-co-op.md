...
title: "[!DNL Device Co-op] FAQ sur la fin de vie"
...
# [!DNL Device Co-op] FAQ sur la fin de vie

Ce document répond aux questions les plus fréquemment posées au sujet de la [!DNL Adobe Experience Cloud Device Co-op] plan de fin de vie (EOL). Lorsque ce plan entrera en vigueur, Adobe vous informera à l’avance dans la variable [Notes de mise à jour des Experience Cloud](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html) et le [Mise à jour prioritaire du produit](https://www.adobe.com/subscription/priority-product-update.html).

[!DNL Device Co-op] a été un programme qui a permis aux participants de travailler ensemble pour mieux identifier les consommateurs à travers les points de contact numériques tout en assurant le niveau de confidentialité et de transparence le plus élevé.
...
- [!DNL Audience Manager] [Destinations basées sur les personnes](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/destinations/people-based/people-based-destinations-overview.html).
